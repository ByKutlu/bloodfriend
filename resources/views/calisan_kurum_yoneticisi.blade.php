                            ...
                            <form action="{{url('addEmployee')}}" method="POST">
                                <div class="modal-body">
                                        ...
                                        <div class="col-lg-4 col-md-12">
                                            ...
                                            <div class="form-group">
                                                <label  class="form-control-label">Rol</label><br/>
                                                <select class="form-control" name="role">
                                                    <option value="normal" selected>Normal</option>
                                                    <option value="manager">Kurum Yöneticisi</option>
                                                </select>
                                            </div>
                                        </div >
                                </div>
            ...
            @foreach($employees as $employee)
                ...
                <tr>
                    ...
                    <td>
                                    ...
                                    <div class="modal-body">
                                        <form method="POST">
                                            ...
                                            <div class="col-lg-4 col-md-12">
                                                ...
                                                <div class="form-group">
                                                    <label >Rol : </label>
                                                    <label>{{$person->employee->role}}</label>
                                                </div>
                                            </div >
                                        </form>
                                    </div>
                        ...
                        <button  data-toggle="modal" rel="tooltip" class="btn btn-success btn-simple btn-xs btnGuncelle" data-target="#guncelle_{{$person->user_id}}" user_id="{{$person->user_id}}" city="{{$person->town->city->city_id}}" town="{{$person->town->town_id}}" blood_group="{{$person->blood_group}}" role="{{$person->employee->role}}" gender="{{$person->gender}}">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                        ...
                                        <div class="col-lg-4 col-md-12">
                                            ...
                                            <div class="form-group">
                                                <label class="form-control-label">Rol</label><br/>
                                                <select class="form-control" name="role" id="role_{{$person->user_id}}">
