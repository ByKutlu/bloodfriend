    ...
    <style class="cp-pen-styles">@import url(https://fonts.googleapis.com/css?family=Raleway:400,100,200,300);
        ...
        *, *:before, *:after {
        ...
        body {
            ...
            text-align: center;
            height: 100%;
            background: -moz-linear-gradient(270deg, rgba(34,46,64,1) 0%, #e53935 100%);
            background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, rgba(34,46,64,1)), color-stop(100%, #e53935));
            background: -webkit-linear-gradient(270deg, rgba(34,46,64,1) 0%, #e53935 100%);
            background: linear-gradient(180deg, rgba(34,46,64,1) 0%, #e53935 100%);
            overflow:hidden;
        }
        ...
        .user .actions a:last-child {
            ...
            background: -moz-linear-gradient(270deg, #e53935 0%, #e53935 100%);
            background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #e53935), color-stop(100%, #e53935));
            background: -webkit-linear-gradient(270deg, #e53935 0%, #e53935 100%);
            background: linear-gradient(180deg, #e53935 0%, #e53935 100%);
        }
        ...
        .content {
            ...
            width: 100%;
            height: 40px;
            background: -moz-linear-gradient(90deg, #e53935 0%, #e53935 100%);
            background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #e53935), color-stop(100%, #e53935));
            background: -webkit-linear-gradient(90deg, #e53935) 0%, #e53935 100%;
            background: linear-gradient(0deg, #e53935 0%, #e53935) 100%;
            -webkit-box-shadow: none;
            -moz-box-shadow: none;
            box-shadow: none;
            overflow: hidden;
...
<div class="login">
    <div class="wrap">
        ...
        <div class="recovery">
            ...
            <p>Lütfen <strong>e-mail adresinizi</strong>  <strong></strong> giriniz !</p>
            <p>  <strong>Not : </strong>E-mail adresinize yolladığımız link şifrenizi yenilemek içindir. </p>
            <form class="recovery-form" action="" method="post">
                <input type="text" class="input" id="user_recover" placeholder="E-mail adresini buraya giriniz">
                <input type="submit" class="button" value="Gönder">
            </form>
            <p class="mssg">E-mail Gönderildi !</p>
        </div>
        ...
        <div class="content">
            <!-- LOGO -->
            <div class="logo">
                <a href="{{"login"}}"><img src="material/img/logo.png" alt=""></a>
            </div>
            <!-- SLIDESHOW -->
            <div id="slideshow">
                <div class="one">
                    <h2><span>KAN DOSTUM</span></h2>
                    <p>Türkiye'nin en yeni kan bulma projesi</p>
                </div>
                <div class="two">
                    <h2><span>HIZLI</span></h2>
                    <p>En hızlı şekilde kan bulma sistemi</p>
                </div>
                <div class="three">
                    <h2><span>GÜVENİLİR</span></h2>
                    <p>Kişisel bilgilerin güvenli şekilde sistem de tutulması</p>
                </div>
                <div class="four">
                    <h2><span>DOSTUNUZ</span></h2>
                    <p>Kan Dostum her zaman sizinle birlikte. Paylaştırcak Yaşarız.</p>
                </div>
            </div>
        </div>
        <!-- LOGIN FORM -->
        <div class="user">
            ...
            <div class="form-wrap">
                <!-- TABS -->
                <div class="tabs">
                    <h3 class="login-tab"><a href="#login-tab-content" class="log-in active" ><span>Giriş<span></a></h3>
                </div>
                <!-- TABS CONTENT -->
                <div class="tabs-content">
                    ...
                    <div id="login-tab-content" class="active">
                        <form class="login-form" action="" method="post">
                            <input type="text" class="input" id="user_login" autocomplete="off" placeholder="Lütfen kullanıcı adını buraya giriniz">
                            <input type="password" class="input" id="user_pass" autocomplete="off" placeholder="Lütfen şifrenizi buraya giriniz">
                            <input type="checkbox" class="checkbox" checked id="remember_me">
                            <label for="remember_me">Beni Hatırla</label>
                            <a href="http://localhost/bloodfriend/public/">  <input  type="submit" class="button" value="Giriş"></a>
                        </form>
                        <div class="help-action">
                            <p><i class="fa fa-arrow-left" aria-hidden="true"></i><a class="forgot" href="#">Şifremi Unuttum</a></p>
                        </div>
                    </div>
                    <!-- TABS CONTENT SIGNUP -->
