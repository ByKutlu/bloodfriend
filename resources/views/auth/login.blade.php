                ...
                <div class="tabs-content">
                    ...
                    <div id="login-tab-content" class="active">
                        <form class="login-form" action="{{ route('login') }}" method="post">
                            {{ csrf_field() }}
                            <input type="text" class="input" id="user_login" autocomplete="off" placeholder="E-Mail" value="{{ old('email') }}" name="email">
                            <input type="password" class="input" id="user_pass" autocomplete="off" placeholder="Lütfen şifrenizi buraya giriniz">
                            <input type="checkbox" class="checkbox" id="remember_me" {{ old('remember') ? 'checked' : '' }}>
                            <label for="remember_me">Beni Hatırla</label>
                            <input  type="submit" class="button" value="Giriş">
                        </form>
                        <div class="help-action">
                            <p><i class="fa fa-arrow-left" aria-hidden="true"></i><a class="forgot" href="{{ route('password.request') }}">Şifremi Unuttum</a></p>
                        </div>
                    </div>
                </div>
            </div>
